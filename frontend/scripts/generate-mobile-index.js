...
// Ensure dist/index.html does NOT exist so Cloudflare Pages routes all requests to _worker.js (SSR)
const distIndex = path.join(__dirname, '..', 'dist', 'index.html');
if (fs.existsSync(distIndex)) {
  fs.unlinkSync(distIndex);
  console.log('✔ Cleaned dist/index.html so Cloudflare Pages executes _worker.js');
}

// Write fallback index.html to .output/public for local mobile sync if needed
